"use strict";
(self["webpackChunk"] = self["webpackChunk"] || []).push([["resources_js_router_views_user_roles_roles_vue"],{
...
/***/ "./node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/dist/index.js??ruleSet[0].use[0]!./resources/js/router/views/user_roles/roles.vue?vue&type=script&lang=js":
/*!************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/dist/index.js??ruleSet[0].use[0]!./resources/js/router/views/user_roles/roles.vue?vue&type=script&lang=js ***!
  \************************************************************************************************************************************************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
var pwd_lowercase = _vuelidate_validators__WEBPACK_IMPORTED_MODULE_4__.helpers.regex(/[a-z]/);
var pwd_uppercase = _vuelidate_validators__WEBPACK_IMPORTED_MODULE_4__.helpers.regex(/[A-Z]/);
var pwd_number = _vuelidate_validators__WEBPACK_IMPORTED_MODULE_4__.helpers.regex(/\d/);
var pwd_special = _vuelidate_validators__WEBPACK_IMPORTED_MODULE_4__.helpers.regex(/[!@#\$%\^\&*\)\(+=._-]/);
var secure_pwd = pwd_lowercase && pwd_uppercase && pwd_number && pwd_special;
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  page: {
    title: "New Role",
    meta: [{
  ...
  data: function data() {
    return {
      ...
      isActive: true,
      title: this.editmode ? this.$t("user_roles.edit-role") : this.$t("user_roles.create-role"),
      form: new Form({
        role_name: ""
      }),
      submitted: false
  ...
  validations: {
    form: {
      role_name: {
        required: _vuelidate_validators__WEBPACK_IMPORTED_MODULE_4__.helpers.withMessage("user_roles.Role Name is required", _vuelidate_validators__WEBPACK_IMPORTED_MODULE_4__.required)
      }
    }
  },
  mounted: function mounted() {
    ...
    this.title = this.editmode ? this.$t("user_roles.edit-role") : this.$t("user_roles.create-role");
    this.getUserData();
  },
  methods: {
    ...
    create: function create(e) {
      ...
      this.form.post("user_role", {
        ...
        if (typeof errors.response.data.errors.role_name[0] !== "undefined") {
          Toast.fire({
            icon: "error",
            title: _this2.$t(errors.response.data.errors.role_name[0])
          });
          return false;
        } else {
          _this2.errors = {};
    ...
    update: function update() {
      ...
      this.isActive = false;
      axios.put("user_role/" + this.id, this.form, {
        headers: {
          "Content-Type": "application/json",
          Accept: "application/json",
          Authorization: "Bearer " + this.token
        ...
        if (typeof errors.response.data.errors.role !== "undefined") {
          Toast.fire({
            icon: "error",
            title: _this3.$t(errors.response.data.errors.role[0])
          });
          return false;
        } else {
          _this3.errors = {};
...
/***/ "./node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/dist/templateLoader.js??ruleSet[1].rules[2]!./node_modules/vue-loader/dist/index.js??ruleSet[0].use[0]!./resources/js/router/views/user_roles/roles.vue?vue&type=template&id=eed55620":
/*!****************************************************************************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/dist/templateLoader.js??ruleSet[1].rules[2]!./node_modules/vue-loader/dist/index.js??ruleSet[0].use[0]!./resources/js/router/views/user_roles/roles.vue?vue&type=template&id=eed55620 ***!
  \****************************************************************************************************************************************************************************************************************************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
    ...
    "default": (0,vue__WEBPACK_IMPORTED_MODULE_0__.withCtx)(function () {
      return [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createVNode)(_component_PageHeader, {
        ...
        onSubmit: _cache[1] || (_cache[1] = (0,vue__WEBPACK_IMPORTED_MODULE_0__.withModifiers)(function ($event) {
          return $data.editmode ? $options.update() : $options.create();
        }, ["prevent"]))
      }, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", _hoisted_5, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", _hoisted_6, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", _hoisted_7, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("label", null, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)(_ctx.$t("user_roles.Role Name")), 1 /* TEXT */), _hoisted_8, (0,vue__WEBPACK_IMPORTED_MODULE_0__.withDirectives)((0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("input", {
        "onUpdate:modelValue": _cache[0] || (_cache[0] = function ($event) {
          return $data.form.role_name = $event;
        }),
        type: "text",
        name: "first_name",
        "class": (0,vue__WEBPACK_IMPORTED_MODULE_0__.normalizeClass)(["form-control", {
          'is-invalid': $data.submitted && $setup.v$.form.role_name.$error
        }]),
        autocomplete: "false"
      }, null, 2 /* CLASS */), [[vue__WEBPACK_IMPORTED_MODULE_0__.vModelText, $data.form.role_name]]), ((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(true), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)(vue__WEBPACK_IMPORTED_MODULE_0__.Fragment, null, (0,vue__WEBPACK_IMPORTED_MODULE_0__.renderList)($setup.v$.form.role_name.$errors, function (error, index) {
      ...
      }), 128 /* KEYED_FRAGMENT */))])])]), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", _hoisted_10, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", _hoisted_11, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", _hoisted_12, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.withDirectives)((0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("button", {
        "class": "btn btn-primary me-1 btn-sm",
        type: "submit",
        disabled: !$data.isActive
      }, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)(_ctx.$t("Save")), 9 /* TEXT, PROPS */, _hoisted_13), [[vue__WEBPACK_IMPORTED_MODULE_0__.vShow, !$data.editmode]]), (0,vue__WEBPACK_IMPORTED_MODULE_0__.withDirectives)((0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("button", {
        "class": "btn btn-primary me-1 btn-sm",
        type: "submit",
        disabled: !$data.isActive
      }, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)(_ctx.$t("Update")), 9 /* TEXT, PROPS */, _hoisted_14), [[vue__WEBPACK_IMPORTED_MODULE_0__.vShow, $data.editmode]]), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createVNode)(_component_router_link, {
        to: "/roles",
...
/***/ "./resources/js/router/views/user_roles/roles.vue":
/*!********************************************************!*\
  !*** ./resources/js/router/views/user_roles/roles.vue ***!
  \********************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/* harmony import */ var _roles_vue_vue_type_template_id_eed55620__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./roles.vue?vue&type=template&id=eed55620 */ "./resources/js/router/views/user_roles/roles.vue?vue&type=template&id=eed55620");
/* harmony import */ var _roles_vue_vue_type_script_lang_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./roles.vue?vue&type=script&lang=js */ "./resources/js/router/views/user_roles/roles.vue?vue&type=script&lang=js");
/* harmony import */ var C_xampp_htdocs_student_course_student_management_node_modules_vue_loader_dist_exportHelper_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./node_modules/vue-loader/dist/exportHelper.js */ "./node_modules/vue-loader/dist/exportHelper.js");
...
;
const __exports__ = /*#__PURE__*/(0,C_xampp_htdocs_student_course_student_management_node_modules_vue_loader_dist_exportHelper_js__WEBPACK_IMPORTED_MODULE_2__["default"])(_roles_vue_vue_type_script_lang_js__WEBPACK_IMPORTED_MODULE_1__["default"], [['render',_roles_vue_vue_type_template_id_eed55620__WEBPACK_IMPORTED_MODULE_0__.render],['__file',"resources/js/router/views/user_roles/roles.vue"]])
/* hot reload */
if (false) {}
...
/***/ "./resources/js/router/views/user_roles/roles.vue?vue&type=script&lang=js":
/*!********************************************************************************!*\
  !*** ./resources/js/router/views/user_roles/roles.vue?vue&type=script&lang=js ***!
  \********************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/***/ "./resources/js/router/views/user_roles/roles.vue?vue&type=template&id=eed55620":
/*!**************************************************************************************!*\
  !*** ./resources/js/router/views/user_roles/roles.vue?vue&type=template&id=eed55620 ***!
  \**************************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "render": () => (/* reexport safe */ _node_modules_babel_loader_lib_index_js_clonedRuleSet_5_use_0_node_modules_vue_loader_dist_templateLoader_js_ruleSet_1_rules_2_node_modules_vue_loader_dist_index_js_ruleSet_0_use_0_roles_vue_vue_type_template_id_eed55620__WEBPACK_IMPORTED_MODULE_0__.render)
/* harmony export */ });
/* harmony import */ var _node_modules_babel_loader_lib_index_js_clonedRuleSet_5_use_0_node_modules_vue_loader_dist_templateLoader_js_ruleSet_1_rules_2_node_modules_vue_loader_dist_index_js_ruleSet_0_use_0_roles_vue_vue_type_template_id_eed55620__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! -!../../../../../node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!../../../../../node_modules/vue-loader/dist/templateLoader.js??ruleSet[1].rules[2]!../../../../../node_modules/vue-loader/dist/index.js??ruleSet[0].use[0]!./roles.vue?vue&type=template&id=eed55620 */ "./node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/dist/templateLoader.js??ruleSet[1].rules[2]!./node_modules/vue-loader/dist/index.js??ruleSet[0].use[0]!./resources/js/router/views/user_roles/roles.vue?vue&type=template&id=eed55620");
